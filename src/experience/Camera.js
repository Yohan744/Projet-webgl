...
export default class Camera {
    constructor() {
        ...
        this.basicCameraPosition = new THREE.Vector3(2.4, 2, -1.5);
        this.basicLookingPoint = new THREE.Vector3(4, -2.25, 0);
    ...
    setInstance() {
        ...
        this.instance = new THREE.PerspectiveCamera(30, width / this.config.height, 0.1, 50);
    ...
    setKeyListener() {
        window.addEventListener('keydown', (event) => {
            if (event.key === 'a') {
                this.moveCameraZ(new THREE.Vector3(this.modes.default.instance.position.x, this.modes.default.instance.position.y, 0));
            }
        });
    }
